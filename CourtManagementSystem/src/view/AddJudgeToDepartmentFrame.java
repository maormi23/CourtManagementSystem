...
public class AddJudgeToDepartmentFrame extends JFrame {
    ...
    public AddJudgeToDepartmentFrame(Court court) {
        this.court = court;

        setTitle("Add Judge to Department");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setSize(560, 240);
        setLocationRelativeTo(null);
        setLayout(null);

        JLabel title = new JLabel("Add Judge to Department", SwingConstants.CENTER);
        ...
        JLabel lJudge = new JLabel("Judge:");
        lJudge.setBounds(40, 105, 120, 25);
        add(lJudge);
        judgeBox.setBounds(160, 105, 360, 28);
        add(judgeBox);
    ...
    private void onAdd() {
        ...
        JudgeItem jItem = (JudgeItem) judgeBox.getSelectedItem();
        if (dItem == null || dItem.ref == null || jItem == null || jItem.ref == null) {
            JOptionPane.showMessageDialog(this, "Select department and judge.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            court.addJudgeToDepartment(dItem.ref, jItem.ref);
            JOptionPane.showMessageDialog(this, "Judge added to department (and set as manager if needed).");
            dispose();
