...
public class AddLawyerFrame extends JFrame {
    ...
    public AddLawyerFrame(Court courtSystem) {
        setTitle("Add New Lawyer");
        ...
        JLabel title = new JLabel("Add New Lawyer", SwingConstants.CENTER);
        ...
        saveButton.setBounds(370, 410, 100, 40);
        add(saveButton);
        ...
        cancelButton.setBounds(130, 410, 100, 40);
        ...
        saveButton.addActionListener(e -> {
            try {
                ...
                Lawyer newLawyer = new Lawyer(
                        ...
                        specialization, license, salary
                );

                courtSystem.addLawyer(newLawyer);
                ...
                JOptionPane.showMessageDialog(this, "ID, License, and Salary must be numeric.", "Error", JOptionPane.ERROR_MESSAGE);
